...
public class HandlePopupWindow extends BaseTest {
    ...
    @Test
    public void testPopupWindow02() {
        //Cách thứ hai dùng vị trí trong collection Set (driver.getWindowHandles)
        ...
        //Câu lệnh chính để chuyển hướng đến cửa s thứ 2
